      ...
      <div className="container">
        ...
        <div className="relative">
          <div className="relative flex items-center z-1 h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <Generating className="absolute border lg:-translate-x-1/2 left-4 ring-4 bottom-4 border-n-1/10 lg:left-1/2 lg:right-auto lg:bottom-8" />
          </div>
          ...
          <div className="relative grid gap-5 z-1 lg:grid-cols-2">
            ...
            <div className="p-4 overflow-hidden bg-n-7 rounded-3xl lg:min-h-[46rem]">
              <div className="px-4 py-12 xl:px-t">
                  ...
                  {brainwaveServicesIcons.map((item, index) => (
                    ...
                    >
                      <div
                        className={
                          index === 2
                            ? 'flex justify-center items-center bg-n-7 h-full w-full rounded-[1rem]'
                            : ''
                        }
                      >
